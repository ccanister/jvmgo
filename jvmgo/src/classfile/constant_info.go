...
func newConstantInfo(tag uint8, cp ConstantPool) ConstantInfo {
	...
	case CONSTANT_InterfaceMethodref:
		return &ConstantInterfaceMethoderInfo{ConstantMemberrefInfo{cp:cp}}
	case CONSTANT_NameAndType:return &ConstantNameAndTypeInfo{}
	//case CONSTANT_MethodType:return &ConstantMethodT
	//case CONSTANT_MethodHandle:return &CM
	//
	default:
		panic("java.lang.ClassFomatError: constant pool tag")
	}
}